# Lektion 12 fehlerbehandlung und observability
...
## Dateiuebersicht
- `app-logger.ts`: Strukturierter Logger, Learning: Lernt observability-freundliche Logevents
- `route-with-error-handling.ts`: Fehlerbehandlungsroute, Learning: Lernt try/catch plus kontrollierte 500-Antwort
